...
class GraphMixer(nn.Module):
    def __init__(self, args):
        ...
        self.temporal_unit = nn.GRUCell(2,
                                        2)  # 不同场景不一致，2s3z:5,5 3s5z:5,5 8m:8,8, 3s_vs_5z:3,3,5m_vs_6m:5,5,mmm2:10,10 27m_vs_30m:27,27 8m_vs_9m:8,8 2c_vs_64zg:2,2
    ...
    def forward(self, agent_qs, states,
        ...
        return q_tot, local_rewards, alive_agents.view(bs2, -1, self.n_agents)
